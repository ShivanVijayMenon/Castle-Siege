...
function setup() {
  ...
  polygon = Bodies.rectangle(200, 200, 40, 40, polOptions);
  ...
  blockb6 = new Block(665, 135, 30, 40);
  blockb7 = new Block(695, 135, 30, 40);
  blockb8 = new Block(725, 135, 30, 40);

  blockb9 = new Block(695, 95, 30, 40);
